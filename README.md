# Claude 国内免费使用指南（支持Claude 4 Sonnet，无需翻墙）【7月持续更新】
...
[**Claude 中文版**](https://talk.lanjing.pro) 是由 Anthropic 开发的 Claude 4 Sonnet 模型的中文使用版本，专为中文用户提供更流畅、更精准的对话体验。  
...
|------------------|--------------------------------|-------------|---------|---------|-----|------|
| **蓝鲸 AI**     | [https://talk.lanjing.pro/](https://talk.lanjing.pro/) | Claude 4，GPT-4o，Gemini | 有       | 国内邮箱注册 | 高   | 中文支持，Claude 4，GPT-4o绘图 |
